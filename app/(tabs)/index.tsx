    ...
    <ScreenWrapper>
     <View style = {styles.container}>
      ...
      <View style = {styles.header}>
        <View style ={{gap:4}}>
          <Typo size={26} color={colors.neutral400}>Hello,</Typo>
      ...
      <ScrollView 
      contentContainerStyle = {styles.scrollViewStyle} showsVerticalScrollIndicator = {false}>
        {/**card */}
        <View>
          <HomeCard/>
        </View>
     ...
     <Button style={styles.floatingButton} onPress={()=>router.push('/(models)/TransactionModal')}>
      <Icons.Plus
      color={colors.black}
      weight='bold'
